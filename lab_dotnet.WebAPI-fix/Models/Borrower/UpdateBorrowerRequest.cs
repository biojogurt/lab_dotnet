...
public class UpdateBorrowerRequest
{
    ...
    public class Validator : AbstractValidator<UpdateBorrowerRequest>
    {
        public Validator()
        {
...
public static class UpdateBorrowerRequestExtension
{
    public static ValidationResult Validate(this UpdateBorrowerRequest model)
    {
        return new UpdateBorrowerRequest.Validator().Validate(model);
    }
}